...
if flag:
    ...
    for i in range(2):
        ...
        print("\niter:{}, running_mean.shape: {}".format(i, bn.running_mean))
        print("iter:{}, running_var.shape: {}".format(i, bn.running_var))

        print("iter:{}, weight.shape: {}".format(i, bn.weight))
        print("iter:{}, bias.shape: {}".format(i, bn.bias))
