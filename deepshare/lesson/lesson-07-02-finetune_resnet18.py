...
# 2/3 加载参数  决定是否使用pretrain模型？不使用的话，相当于从头训练1个resnet18，准确率是很低的
# flag = 0
flag = 1
if flag:
...
resnet18_ft.fc = nn.Linear(num_ftrs, classes)    # 相当于只有fc层的参数需要重新学习，也是少量样本可以的微调出来的结果


resnet18_ft.to(device)  # 模型放到gpu上训练
# ============================ step 3/5 损失函数 ============================
